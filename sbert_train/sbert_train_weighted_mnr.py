...
import logging
import csv
from custom_loss import WeightedMultipleNegativesRankingLoss

parser = argparse.ArgumentParser()
parser.add_argument('--pretrained_model_path', default='cl-tohoku/bert-base-japanese-v3')
...
train_samples = sbert_train_util.load_nli_dataset_for_WeightedMNRLoss(
    TRAIN_DATASET_PATH, WEIGHT)
